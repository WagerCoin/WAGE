...
void StatisticsPage::updateStatistics()
{
    ...
    {
		subsidy = "140000 WAGE per block";
    }
	else if(pindexBest->nHeight < 160)
    {
		subsidy = "0 WAGE per block";
    }
	else if(pindexBest->nHeight < 14000)
    {
		subsidy = "500 WAGE per block";
    }
    ...
    {
        ui->volumeBox->setText("<b><font color=\"#ebbcff\">" + qVolume + " WAGE" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " WAGE" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " WAGE");
    }
